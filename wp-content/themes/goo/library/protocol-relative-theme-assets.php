...
if ( ! class_exists( 'goo_protocol_relative_theme_assets' ) ) :
	class goo_protocol_relative_theme_assets {
		/**
	...
	$goo_protocol_relative_theme_assets = new goo_protocol_relative_theme_assets;
endif;
