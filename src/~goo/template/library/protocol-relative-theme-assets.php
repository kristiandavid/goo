...
if ( ! class_exists( 'breeyn_protocol_relative_theme_assets' ) ) :
	class breeyn_protocol_relative_theme_assets {
		/**
	...
	$breeyn_protocol_relative_theme_assets = new breeyn_protocol_relative_theme_assets;
endif;
