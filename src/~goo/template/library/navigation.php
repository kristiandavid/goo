...
if ( ! function_exists( 'main' ) ) {
	function main() {
	    wp_nav_menu(array(
	        ...
	        'menu' => '',                                   // Menu name
	        'menu_class' => 'mainNav',            // Adding custom nav class
	        ...
	        'walker' => new breeyn_Top_Bar_Walker(),
	    ));
	}
}
...
if ( ! function_exists( 'footer' ) ) {
	function footer() {
	    wp_nav_menu(array(
	        ...
	        'container_class' => '',                        // Class of container
	        'menu' => '',                                   // Menu name
	        'menu_class' => 'tfooterNav',           // Adding custom nav class
...
*/
if ( ! function_exists( 'breeyn_add_menuclass' ) ) {
	function breeyn_add_menuclass( $ulclass ) {
	    $find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
	    $replace = array('<a rel="button" class="button"', '<a rel="button" class="button"');

	    return preg_replace( $find, $replace, $ulclass, 1 );
	}
	add_filter( 'wp_nav_menu','breeyn_add_menuclass' );
}
...
if ( ! function_exists( 'breeyn_breadcrumb' ) ) {
    function breeyn_breadcrumb( $showhome = true, $separatorclass = false ) {
