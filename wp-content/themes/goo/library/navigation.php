...
*/
if ( ! function_exists( 'goo_add_menuclass' ) ) {
	function goo_add_menuclass( $ulclass ) {
	    $find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
	    $replace = array('<a rel="button" class="button"', '<a rel="button" class="button"');

	    return preg_replace( $find, $replace, $ulclass, 1 );
	}
	add_filter( 'wp_nav_menu','goo_add_menuclass' );
}
...
if ( ! function_exists( 'goo_breadcrumb' ) ) {
    function goo_breadcrumb( $showhome = true, $separatorclass = false ) {
